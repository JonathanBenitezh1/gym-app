            ...
            {seccionAbierta === 'rutinas' && (
              <div className="pb-4" style={{ borderTop: '1px solid #e0ecf4' }}>
                {rutinas.length === 0
                  ...
                  : rutinas.map(rutina => (
                    <div key={rutina.id}>
                      <div className="px-5 py-3" style={{ borderBottom: '1px solid #e0ecf4' }}>
                      ...
                      {rutina.sesiones?.map(sesion => (
                        <div key={sesion.id}>
                          ...
                          >
                            <p className="text-sm font-semibold uppercase" style={{ color: '#2c4a5a' }}>
                              {sesion.nombre}
                            </p>
                            <span style={{ color: '#87CEEB' }}>
                            ...
                            <div style={{ backgroundColor: '#f0f7ff' }}>
                              {sesion.ejercicios?.map((ej, idx) => (
                                <div key={idx} className="px-5 py-2"
                                  ...
                                  <p className="text-sm font-medium uppercase" style={{ color: '#2c4a5a' }}>
                                    {ej.nombre}
                                  </p>
